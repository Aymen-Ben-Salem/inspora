...
export function ProfilePageClient({
  ...
  return (
    <>
      ...
      />
      {owner ? (
        <button type="button" disabled aria-disabled="true" title="Submissions are not available yet" className="fixed bottom-[36px] left-1/2 z-30 min-h-[41px] w-[104px] -translate-x-1/2 cursor-not-allowed bg-[#262626] px-4 py-3 text-sm font-normal leading-[normal] tracking-[0.2px] text-white shadow-[0_1px_1px_#e6e6e6]">
          Submit
        </button>
      ) : null}

  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`ios-no-focus-zoom focus-ring min-w-0 flex-1 border border-[#e6e6e6] bg-[#fafafa] text-[13px] tracking-[-0.002em] text-[#555] outline-none transition-colors placeholder:text-[#8b8b8b] focus:border-[#aaa] lg:text-[14px] ${
          compact
      ...
      <button
        ...
        className={`focus-ring shrink-0 bg-[#262626] text-[13px] tracking-[-0.002em] text-white transition-colors hover:bg-black disabled:cursor-wait disabled:opacity-60 lg:text-[14px] ${
          compact
